...
- For objective examinations administered via the [Online CBT Portal](/exams/online-exams-system), multiple choice and true/false scores are computed automatically upon submission and transferred directly into the gradebook.
...
5. **Published:** Final marks and letter grades become visible on the [Student Portal](/student/grades-report-cards) and [Parent Portal](/parent/grades).
...
- [Online CBT Examination System](/exams/online-exams-system) — Authoring computer-based tests, question banks, and timer controls.
- [Teacher Gradebook Entry Manual](/teacher/gradebook-entry) — Detailed teacher walkthrough for continuous assessments.
- [Report Card Generation & PDF Export](/registrar/report-cards) — Printing terminal report cards for students and parents.
- [Student Early Warning Risk Engine](/director/student-risk) — Identifying academically struggling students before exams.
