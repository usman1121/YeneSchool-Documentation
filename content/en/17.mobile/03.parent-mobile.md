...
- [QR Attendance & ID Scanning](/en/mobile/qr-attendance) — How student ID badges are scanned at school gates
- [Mobile Offline Sync Engine](/en/mobile/offline-sync) — Local caching and synchronization architecture
- [Parent & Student Web Portal Guide](/en/parent/overview) — Full overview of the desktop parent portal
