...
- [Teacher Mobile Experience](/en/mobile/teacher-mobile) — Offline attendance, grade entry, and digital communication
- [Parent Mobile Experience](/en/mobile/parent-mobile) — Real-time attendance notifications, report cards, and fee payments
- [QR Attendance & ID Scanning](/en/mobile/qr-attendance) — Fast camera barcode scanning for roll-calls and gate security
