...
- [AI Timetable & Auto-Assignment Engine](/en/operations/timetable-engine) — Automated scheduling and conflict resolution
- [Transport & Fleet Management](/en/operations/transport) — Manage school transportation logistics
- [Director User Profile & Security](/en/platform/user-profile-security) — Configure two-factor authentication and session controls
