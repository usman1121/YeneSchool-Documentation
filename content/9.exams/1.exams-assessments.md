...
description: Complete guide to planning, configuring, proctoring, grading, and moderating school-wide examinations and continuous assessments.
navigation:
...
```
[Draft / Scheduled] ──> [Active / In-Progress] ──> [Grading & Moderation] ──> [Director Approval] ──> [Published to Parents]
```
