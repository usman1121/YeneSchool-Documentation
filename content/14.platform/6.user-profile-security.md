...
description: Managing your personal profile, changing passwords, setting up Two-Factor Authentication (2FA), active sessions, and Telegram alerts.
navigation:
...
```
[Current Password] ──> [New Strong Password] ──> [Confirm New Password] ──> [Save & Invalidate Old Sessions]
```
...
- [Platform Settings & Branding](/director/school-settings) — Configuring school-wide login defaults.
- [Notification Gateways](/platform/notifications) — Configuring SMS, Telegram, and Push channels.
- [Reporting Issues & Contacting Support](/guides/support-error-reporting) — Submitting support tickets.
