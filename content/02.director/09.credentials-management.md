...
- [Teacher Performance & Evaluation](/director/teacher-evaluation) — Monitor teacher attendance, lesson completion, and ratings
- [School-Wide Settings & Configuration](/director/school-settings) — Define password complexity rules and session timeouts
- [User Profile & 2FA Security](/platform/user-profile-security) — Setting up Two-Factor Authentication and trusted devices
