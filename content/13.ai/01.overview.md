...
- [Autonomous AI Engine & Background Autopilots](/ai/autonomous-autopilot) — How background AI monitors risk, absence, and daily briefings
- [Timetable Substitution Watchdog](/ai/timetable-watchdog) — Automated absence matching and Telegram period swaps
- [Empathetic Parent Dialogue Engine](/ai/parent-empathy-dialogue) — Automated empathetic SMS alerts and family outreach
- [AI Configuration & Model Settings](/ai/ai-settings) — Setting up API keys, model tiers, and feature toggles
