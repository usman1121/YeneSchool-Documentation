...
1. Open your web browser and navigate to your school's YeneSchool portal address (e.g., `https://yeneschool.com` or your institution's custom domain).
...
- [Role-Based Access Matrix](/guides/role-based-access) — Overview of permissions per role
- [Director Guide Overview](/director/overview) — Academic and administrative controls
- [Teacher Guide Overview](/teacher/overview) — Classroom workflows and grading
- [Parent Guide Overview](/parent/overview) — Monitoring your child's educational progress
