...
description: How to report software errors, submit diagnostic logs, track support tickets, and request custom feature enhancements.
navigation:
...
```
[Click Help / Report Issue] ──> [Fill Diagnostic Form] ──> [Attach Screenshots] ──> [Submit Ticket]
```
...
| **Official Support Email** | 24-Hour SLA Response | `support@yeneschool.com` |
...
- [User Profile & 2FA Security](/platform/user-profile-security) — Securing your account credentials.
- [Director Dashboard Overview](/director/overview) — Navigating school command centers.
- [Offline Mode & Data Sync](/platform/offline) — Troubleshooting offline PWA data synchronization.
